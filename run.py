...
def parseArgs():
    ...
    parser.add_argument('--optimizer', choices=['obproxsg_plus', 'obproxsg', 'proxsg', 'proxsvrg', 'rda'], type=str, required=True)
...
def main():
    ...
    trainloader, testloader, num_classes = Dataset(args.dataset_name, args.batch_size)
    ...
    setting = '%s_%s_%s_%E' % (args.optimizer, args.backend, args.dataset_name, args.lambda_)
    ...
    while True:
        ...
        F, f, norm_l1_x = compute_F(trainloader, model, weights, criterion, args.lambda_)
